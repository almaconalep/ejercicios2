...
print(lista_mascotas[-1]) #último elemento
print(lista_mascotas[2:5])  # Secuencia[inicio:fin-1]
print(lista_mascotas[:4])   # Secuencia[:fin-1]
print(lista_mascotas[3:])   # Secuencia[inicio:]
print(lista_mascotas[1:8:2])  # Secuencia[inicio:fin-1:avance]
