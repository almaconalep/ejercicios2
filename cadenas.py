...
print("-"*30)
total=5500
#mensaje="El total de la compra es: "+total+" pesos" causa ERROR
...
print(nombres.upper())
print(nombres.lower())
print(nombres.capitalize()) #Primera letra de la oracion mayùscula
print(nombres.title())   #Primera letra de cada palabra mayúscula
print(nombres.replace("a","x"))
print(nombres.split(","))
print(nombres.count("a"))
print(elementos.count("a"))
print(nombres.split(",")[0]) 
print(nombres.split(",")[-1]) #imprime el último elemento de la lista
print(nombres.split(",")[-2])
#print(nombres.split(",")[-6])
print(nombres.replace("Juan","Pedro"))
print(nombres.replace(","," "))
print(nombres.endswith("Luis")) #la cadena termina con Luis?
...
porque se juntó con {}"""
mitote_completo=mitote.format(*nombres.split(","))# * es un apuntador, le quita los corchetes a la lista y separa los elementos
